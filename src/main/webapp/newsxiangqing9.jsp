			...
			<div class="content">
				...
				<div class="newsc_weizhi">
					...
					<span>您当前所在的位置》<a href="ebooklist-1.aspx.htm" >意林杂志</a> > <a
						href="ebsearch.aspx-t=94.htm" >《意林》</a>
						2016年5月上 总第09期
					</span>
				...
				<div class="newsc_content">
					<div class="newsc_content_left">
						<div class="eblm_c_title">
							<table width="650" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="eblm_c_tl"><img alt="" width="130" height="180"
										src="image/131086198181160000130_180.png" /></td>
									<td class="eblm_c_tr"><table width="500" border="0"
											cellspacing="0" cellpadding="0">
											<tr>
												<td colspan="2"><a href="ebsearch.aspx-t=94.htm"
													tppabs="http://www.yilin.net.cn/EBook/ebsearch.aspx?t=94">《意林》</a>
													2016年5月上 总第09期</td>
											</tr>
											<tr>
												<td colspan="2">纸刊定价：<i class="lv">￥<b class="dazi">5.00</b></i></td>
											</tr>
											<tr>
												<td>电子期刊定价：￥5.00</td>
												<td><i class="hong bold">VIP</i>免费 如何加入<i class="bold">VIP?</i></td>
											</tr>
											<tr>
												<td>ISSN： ISSN1007-3841</td>
												<td>邮发代号：16-288</td>
											</tr>
											<tr>
												<td colspan="2">出版日期：每月10日 25日</td>
											</tr>
										</table></td>
								</tr>
							</table>
							...
							<ul>
								<li><h1>卷首</h1>
									<ul>
										<div class="m m1">
											<div class="con">
												<li class="eblm_c_bh"><span class="eblm_c_bh_fl"><a
														href="ebookc.aspx-id=4126&t=498.htm" 
														target="_blank">慢浸为毒</a> </span> <span class="eblm_c_bh_fr">倪西赞
												</span></li>
											</div>
										</div>
									</ul></li>
								...
								<li><h1>心灵鸡汤</h1>
									<ul>
										<div class="m m1">
											<div class="con">
												<li class="eblm_c_bh"><span class="eblm_c_bh_fl"><a
														href="ebookc.aspx-id=4127&t=498.htm" 
														target="_blank">接受现状就是圆满</a> </span> <span class="eblm_c_bh_fr">吴淡如
												</span></li>
											</div>
										</div>
									</ul></li>
								...
								<li><h1>励志人物榜</h1>
									<ul>
										<div class="m m1">
											<div class="con">
												<li class="eblm_c_bh"><span class="eblm_c_bh_fl"><a
														href="ebookc.aspx-id=4128&t=498.htm" 
														target="_blank">投行男的《琅琊榜》</a> </span> <span class="eblm_c_bh_fr">安以默
												</span></li>
											</div>
										</div>
									</ul></li>
								...
								<li><h1>非常故事</h1>
									<ul>
										<div class="m m1">
											<div class="con">
												<li class="eblm_c_bh"><span class="eblm_c_bh_fl"><a
														href="ebookc.aspx-id=4129&t=498.htm" 
														target="_blank">幻兽师</a> </span> <span class="eblm_c_bh_fr">雨魔
												</span></li>
											</div>
										</div>
									</ul></li>
