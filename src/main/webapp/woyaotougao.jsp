				...
				<div class="newsc_content">
					<div class="newsc_content_left">
						<div class="newsc_c_l_title">
							<h1 class="artibodyTitle">意林投稿邮箱--我要投稿</h1>
							<div class="artInfo">
								<span class="pub_date">2014-12-7 10:19:20</span> <span
									class="media_name"> 来源：<i>意林</i></span><span class="media_name">
									作者：<i>意林</i>
								</span><span class="media_name"> 点击：<i>91605</i></span>
							</div>
						</div>
						<div class="newsc_c_l_body">
							<p class="MsoNormal">
								<span style="line-height: 1.5;">意林：</span><a
									href="mailto:yilin010@vip.163.com">yilin010@vip.163.com</a>
							</p>
							<p class="MsoNormal">
								意林原创版：<a href="mailto:yilinjiangshu@sina.com">yilinjiangshu@sina.com</a>
							</p>
							<p class="MsoNormal">
								意林少年版：&nbsp;<a href="mailto:xiaoyilin.love@163.com">xiaoyilin.love@163.com</a>
							</p>
							<p class="MsoNormal">
								意林小文学投稿邮箱：<a href="mailto:xiaowenxue@yilin.net.cn">xiaowenxue@yilin.net.cn</a>
							</p>
							<p class="MsoNormal">
								意林小淑女-小小姐：<a href="mailto:tiancaixsn@sina.com">tiancaixsn@sina.com</a>
							</p>
							<p class="MsoNormal">
								意林12+绘阅读：<a href="mailto:yilin12jia@163.com">yilin12jia@163.com</a>
							</p>
							<p class="MsoNormal">
								意林绘英语：<a href="mailto:yilinhuiyingyu@163.com">yilinhuiyingyu@163.com</a>
							</p>
							<p class="MsoNormal">
								意林作文素材：<a href="mailto:1300990915@qq.com">1300990915@qq.com</a>
							</p>
							<p class="MsoNormal">
								意林儿童绘本：<a href="mailto:yilinpicturebook@sina.com">yilinpicturebook@sina.com</a>
							</p>
							<p class="MsoNormal">
								意林环球儿童文学：<a href="mailto:yilinsandy@126.com">yilinsandy@126.com</a>
							</p>
							<p class="MsoNormal">
								插画投递邮箱：<a href="mailto:yilinart@163.com">yilinart@163.com</a>
							</p>
							<p class="MsoNormal">
								轻小说：<a href="mailto:qingxiaoshuo@yilin.net.cn">qingxiaoshuo@yilin.net.cn</a>或&nbsp;<a
									href="mailto:ylqingxiaoshuo@sina.cn">ylqingxiaoshuo@sina.cn</a>
							</p>
							<p>
								<br />
							</p>
							<a href="mailto:yilinsandy@126.com"></a>
						</div>
					...
					<div class="newsc_content_right">
						...
						<div class="list_ad2">
							<a target="_blank"
								href="javascript:if(confirm('http://m.yilin.net.cn/  '))window.location='http://m.yilin.net.cn/'"
								title="手机版"><img alt="手机版" width="278px" height="254px"
								src="image/130019972652343750.jpg" /></a>
						</div>
						<div class="list_ad3">
							<a target="_blank"
								href="javascript:if(confirm('http://www.bjdxyxcb.com/jieti.html '))window.location='http://www.bjdxyxcb.com/jieti.html'"
