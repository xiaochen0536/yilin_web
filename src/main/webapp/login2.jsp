						...
						<table width="380" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><div class="reg_item">
										<input name="ctl00$ContentPlaceHolder1$ValidateCode"
											type="text" id="ContentPlaceHolder1_ValidateCode"
											class="validtxt" /> <b><A href=""> <img id="getcode"
												src="image/ValidateCode.aspx.jpg" src="" /></b><b>看不清 换一张</b> </A>
									</div></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input type="submit" value=""> <label
									for="ContentPlaceHolder1_CheckBox1">下次自动登录</label> 忘记密码？</td>
							</tr>
							<tr>
								<td></td>
								<td><input type="submit" value="登录">
									&nbsp;&nbsp;&nbsp;&nbsp;<a href="register2.jsp" class="lv">注册</a></td>
							</tr>
						</table>
					</form>
				</div>
