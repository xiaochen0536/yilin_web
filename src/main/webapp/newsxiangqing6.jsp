				...
				<div class="newsc_content">
					<div class="newsc_content_left">
						<div class="newsc_c_l_title">
							<h1 class="artibodyTitle">福建省漳州市诏安县教育局：官陂中学举办第四届“意林杯”现场作文大赛</h1>
							<div class="artInfo">
								<span class="pub_date">2017-1-12 14:39:32</span> <span
									class="media_name"> 来源：<i>官陂中学</i></span><span
									class="media_name"> 作者：<i>官陂中学</i></span><span
									class="media_name"> 点击：<i>2176</i></span>
							</div>
						</div>
						<div class="newsc_c_l_body">
							<p
								style="text-align: left; background-color: #ffffff; text-indent: 2em; color: #000000;">
								<span style="font-size: 18px;"><a
									href="http://www.zajy.net/newsInfo.aspx?pkId=5989">http://www.zajy.net/newsInfo.aspx?pkId=5989</a></span>
							</p>
							<p
								style="text-align: left; background-color: #ffffff; text-indent: 2em; color: #000000;">
								<span style="font-size: 18px;">为激发学生的写作兴趣，提高学生的写作水平和文明礼仪意识，&nbsp;元月10日，由校教务处和语文教研组联合组织开展了官陂中学第四届“意林杯”现场作文大赛。大赛以“守望”为主题。</span>
							</p>
							<p
								style="text-align: left; background-color: #ffffff; text-indent: 2em; color: #000000;">
								<span style="font-size: 18px;">&nbsp;
									赛后，该校语文教研组教师将从参赛的80名学生中评出一、二、三等奖若干名，同时还会将选出来的优秀作品在学校宣传栏上进行展览，让更多的同学在这次活动中受到教育。</span>
							</p>
							<p
								style="text-align: left; background-color: #ffffff; text-indent: 2em; color: #000000;">
								<span style="font-size: 18px;">&nbsp;
									此次现场作文比赛，不仅给学生提供了一个展示自我的平台，还锻炼和提高了学生的文字表达能力，激发了学生的写作积极性，提高了学生的语文素养。</span>
							</p>
							<p
								style="text-align: left; background-color: #ffffff; text-indent: 0px; color: #000000;">
								<img title="" alt="" src="image/20170111071829_7510.JPG"
									width="600" height="450" /><img title="" alt=""
									src="image/20170111071830_1820.JPG"
									width="600" height="450" /><img title="" alt=""
									src="image/20170111071830_6100.JPG"
									width="600" height="450" /><img title="" alt=""
									src="image/20170111071831_0160.JPG"
									width="600" height="450" /><img title="" alt=""
									src="image/20170111071831_3860.JPG"
