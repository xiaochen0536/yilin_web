				...
				<div class="newsc_content">
					<div class="newsc_content_left">
						<div class="newsc_c_l_title">
							<h1 class="artibodyTitle">${NewsSelect.ntitle }</h1>
							<div class="artInfo">
								<span class="pub_date"><fmt:formatDate value="${n.ntime }" type="date" pattern="yyyy-MM-dd HH:mm:ss"/></span><span
									class="media_name"> 作者：<i>${NewsSelect.nauthor }</i></span><span
									class="media_name"> 点击：<i>${NewsSelect.ncount }</i></span>
							</div>
						</div>
						<div class="newsc_c_l_body">
							<p>
								<img src="${NewsSelect.npic }" alt="" />01
							</p>
							${NewsSelect.ncontent }
