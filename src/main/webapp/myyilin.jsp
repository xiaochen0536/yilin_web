		...
		<div>
			...
			<div class="member_content">
				<div class="member_left">
					...
					<div class="member_lefttop">
						<a href="../Member/Myyilin.aspx"><img src="image/member1.png" /></a>
					</div>
					<div class="member_leftc">
						<div class="member_leftc_title">我的关注</div>
						<div class="member_leftc_c">
							<ul>
								<li><a>我看过的</a></li>
								<li><a>我的收藏</a></li>
							</ul>
						</div>
						<div class="member_leftc_title">个人信息管理</div>
						<div class="member_leftc_c">
							<ul>
								<li><a href="../Member/WsMi.aspx">完善个人资料</a></li>
								<li><a href="../Member/Adress.aspx">收货地址管理</a></li>
							</ul>
						</div>
						<div class="member_leftc_title">账户信息</div>
						<div class="member_leftc_c">
							<ul>
								<li><a href="../Member/coupons.aspx">意林币兑换</a></li>
								<li><a href="../Member/yilinbi.aspx">意林币交易记录</a></li>
								<li><a href="../Member/Allorder.aspx">我的订单</a></li>
								<li><a href="../Shop/gouwuche.aspx">购物车</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="member_right">
					<div class="member_right_top"></div>
					<div class="member_r_top_c">
						<div class="my_pic">
							<div>
								<div>
									<a href=Xgtx.aspx> <img src='image/member6.png' width="90"
										height="90" /></a> <a id="J_MtAvatarOperation" href="Xgtx.aspx">修改头像</a><span
										class="head_pic"></span>
								</div>
							</div>
						...
						<div class="my_txt">
							<div class="nickname-info">
								<div class="txt2">
									<p>
										<a id="anickname">您好！ <em id="bNickName" class="hong">wlwl118
										</em>
										</a>
									</p>
									<p>
										<a id="a1">我的会员等级： <em id="Em1" class="hong">普通会员 </em>
										</a>
									</p>
					...
					<div class="member_r_top_bottom_bg"></div>
					<div class="member_right_rmqk">
						<div class="member_r_rmqk_t">
							<div class="member_r_rmqk_t_l"></div>
							<div class="member_r_rmqk_t_c">热门期刊</div>
							<div class="member_r_rmqk_t_r"></div>
						</div>
						<div class="member_r_rmqk_c">

							<div class="member_pic">
								<a href='../EBook/ebooklm.aspx?id=459&t=94' target="_blank">
									<img width="110px" height="154px"
									src='image/131012162890793750210_290.png' />
								</a> <a href='../EBook/ebooklm.aspx?id=459&t=94' target="_blank">
									<div class="zi">
										<i class="left">意林</i><i class="right">总第4期</i>
									</div>
								</a>
							</div>

							<div class="member_pic">
								<a href='../EBook/ebooklm.aspx?id=465&t=101' target="_blank">
									<img width="110px" height="154px"
									src='image/131012167520637500210_290.png' />
								</a> <a href='../EBook/ebooklm.aspx?id=465&t=101' target="_blank">
									<div class="zi">
										<i class="left">原创版</i><i class="right">总第2期</i>
									</div>
								</a>
							</div>

							<div class="member_pic">
								<a href='../EBook/ebooklm.aspx?id=303&t=92' target="_blank">
									<img width="110px" height="154px"
									src='image/130734677713125000210_290.jpg' />
								</a> <a href='../EBook/ebooklm.aspx?id=303&t=92' target="_blank">
									<div class="zi">
										<i class="left">小小姐</i><i class="right">总第8期</i>
									</div>
								</a>
							</div>

							<div class="member_pic">
								<a href='../EBook/ebooklm.aspx?id=300&t=92' target="_blank">
									<img width="110px" height="154px"
									src='image/130734675061718750210_290.jpg' />
								</a> <a href='../EBook/ebooklm.aspx?id=300&t=92' target="_blank">
									<div class="zi">
										<i class="left">小小姐</i><i class="right">总第6期</i>
									</div>
								</a>
							</div>

							<div class="member_pic">
								<a href='../EBook/ebooklm.aspx?id=299&t=92' target="_blank">
									<img width="110px" height="154px"
									src='image/130734674768593750210_290.jpg' />
								</a> <a href='../EBook/ebooklm.aspx?id=299&t=92' target="_blank">
									<div class="zi">
										<i class="left">小小姐</i><i class="right">总第5期</i>
									</div>
								</a>
							</div>
